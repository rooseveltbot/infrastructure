...
public abstract class EntityFrameworkReadOnlyRepository<TEntity> : IReadOnlyRepository<TEntity>
    where TEntity : class, IEntity
{
    protected readonly IEntityFrameworkContext Context;

    protected EntityFrameworkReadOnlyRepository(IEntityFrameworkContext context)
    {
        Context = context;
    }
